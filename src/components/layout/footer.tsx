...
const footerNavigation = {
  programs: [
    { name: "LMS Access", href: "/programs/lms-access" },
    { name: "Full Enrollment", href: "/programs/full-enrollment" },
          ...
          <div className="space-y-6 xl:col-span-1">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-display font-semibold text-xl">
                Crown Science Education
              </span>
            </Link>
            <p className="text-sm text-gray-600">
              Excellence in science education. Personalised learning experiences
              that help students achieve their full academic potential.
            </p>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>admissions@crownscience.edu</span>
              </div>
              <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {footerNavigation.subjects.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-gray-600 hover:text-primary-600 transition-colors"
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 md:mt-0 space-y-2">
              <p className="text-xs text-gray-500">
                &copy; {new Date().getFullYear()} Crown Science Education. All rights reserved.
              </p>
              <div className="flex space-x-4 text-xs text-gray-500">
                ...
                <Link href="/safeguarding" className="hover:text-primary-600">Safeguarding</Link>
              </div>
            </div>
          </div>
        </div>
